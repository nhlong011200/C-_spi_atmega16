...
interrupt [USART_RXC] void usart_rx_isr(void)
{
    ...
    if(uartIndex == 5)
    {
        uartIndex = 0; 
        uartReceive[5] = '\0';
        if(strcmp(uartReceive,"DEN10") == 0)
        {
            PORTB &=0b11111110;
            SPI_Write('1'); 
            PORTB |=0b00000001;
        } 
        else if(strcmp(uartReceive,"DEN11") == 0)
        {
            PORTB &=0b11111110;
            SPI_Write('2'); 
            PORTB |=0b00000001;
        }
        else if(strcmp(uartReceive,"DEN20") == 0)
        {
            PORTB &=0b11111110;
            SPI_Write('3'); 
            PORTB |=0b00000001;
        }
        else if(strcmp(uartReceive,"DEN21") == 0)
        {
            PORTB &=0b11111110;
            SPI_Write('4'); 
            PORTB |=0b00000001;
        ...
        else if(strcmp(uartReceive,"DEN30") == 0)
        {
            PORTB &=0b11111101;
            SPI_Write('1'); 
            PORTB |=0b00000010;
        } 
        else if(strcmp(uartReceive,"DEN31") == 0)
        {
            PORTB &=0b11111101;
            SPI_Write('2'); 
            PORTB |=0b00000010;
        }
        else if(strcmp(uartReceive,"DEN40") == 0)
        {
            PORTB &=0b11111101;
            SPI_Write('3'); 
            PORTB |=0b00000010;
        }
        else if(strcmp(uartReceive,"DEN41") == 0)
        {
            PORTB &=0b11111101;
            SPI_Write('4'); 
            PORTB |=0b00000010;
